...
// Re-exported from breakpoints.ts (the canonical source — see useBreakpoint()) so existing
// `import { TABLET_BREAKPOINT } from './theme'` call sites keep working unchanged.
export { TABLET_MIN_HEIGHT } from './breakpoints';
